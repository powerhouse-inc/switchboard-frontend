...
const TokenForm = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setToken(await createSession(formData.name !== "" ? formData.name : "Default Token", parseInt(formData.duration !== "" ? formData.duration : "60"), formData.allowedOrigin !== "" ? formData.allowedOrigin : "*"));
        setShowModal(true);
    };
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="relative p-6 flex-auto">
                                    <div className="my-4 text-blueGray-500 text-lg leading-relaxed break-words">{token}</div>
                                </div>
                                {/*footer*/}
